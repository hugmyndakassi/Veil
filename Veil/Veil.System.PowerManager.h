...
//#define SystemPowerPolicyAc             ((POWER_INFORMATION_LEVEL)0)      // in: SYSTEM_POWER_POLICY, out: SYSTEM_POWER_POLICY // GET: InputBuffer NULL. SET: InputBuffer not NULL.
//#define SystemPowerPolicyDc             ((POWER_INFORMATION_LEVEL)1)      // in: SYSTEM_POWER_POLICY, out: SYSTEM_POWER_POLICY
//#define VerifySystemPolicyAc            ((POWER_INFORMATION_LEVEL)2)      // in: SYSTEM_POWER_POLICY, out: SYSTEM_POWER_POLICY
//#define VerifySystemPolicyDc            ((POWER_INFORMATION_LEVEL)3)      // in: SYSTEM_POWER_POLICY, out: SYSTEM_POWER_POLICY
//#define SystemPowerCapabilities         ((POWER_INFORMATION_LEVEL)4)      // out: SYSTEM_POWER_CAPABILITIES
//#define SystemBatteryState              ((POWER_INFORMATION_LEVEL)5)      // out: SYSTEM_BATTERY_STATE
//#define SystemPowerStateHandler         ((POWER_INFORMATION_LEVEL)6)      // in: POWER_STATE_HANDLER // (kernel-mode only)
//#define ProcessorStateHandler           ((POWER_INFORMATION_LEVEL)7)      // in: PROCESSOR_STATE_HANDLER // (kernel-mode only)
//#define SystemPowerPolicyCurrent        ((POWER_INFORMATION_LEVEL)8)      // in: SYSTEM_POWER_POLICY
//#define AdministratorPowerPolicy        ((POWER_INFORMATION_LEVEL)9)      // in: ADMINISTRATOR_POWER_POLICY
//#define SystemReserveHiberFile          ((POWER_INFORMATION_LEVEL)10)     // in: BOOLEAN // (requires SeCreatePagefilePrivilege) // TRUE: hibernation file created. FALSE: hibernation file deleted.
//#define ProcessorInformation            ((POWER_INFORMATION_LEVEL)11)     // out: PROCESSOR_POWER_INFORMATION
//#define SystemPowerInformation          ((POWER_INFORMATION_LEVEL)12)     // out: SYSTEM_POWER_INFORMATION
//#define ProcessorStateHandler2          ((POWER_INFORMATION_LEVEL)13)     // in: PROCESSOR_STATE_HANDLER2 // not implemented
//#define LastWakeTime                    ((POWER_INFORMATION_LEVEL)14)     // out: ULONGLONG // InterruptTime
//#define LastSleepTime                   ((POWER_INFORMATION_LEVEL)15)     // out: ULONGLONG // InterruptTime
//#define SystemExecutionState            ((POWER_INFORMATION_LEVEL)16)     // out: EXECUTION_STATE // NtSetThreadExecutionState
//#define SystemPowerStateNotifyHandler   ((POWER_INFORMATION_LEVEL)17)     // in: POWER_STATE_NOTIFY_HANDLER // (kernel-mode only)
//#define ProcessorPowerPolicyAc          ((POWER_INFORMATION_LEVEL)18)     // in: PROCESSOR_POWER_POLICY // not implemented
//#define ProcessorPowerPolicyDc          ((POWER_INFORMATION_LEVEL)19)     // in: PROCESSOR_POWER_POLICY // not implemented
//#define VerifyProcessorPowerPolicyAc    ((POWER_INFORMATION_LEVEL)20)     // in: PROCESSOR_POWER_POLICY // not implemented
//#define VerifyProcessorPowerPolicyDc    ((POWER_INFORMATION_LEVEL)21)     // in: PROCESSOR_POWER_POLICY // not implemented
//#define ProcessorPowerPolicyCurrent     ((POWER_INFORMATION_LEVEL)22)     // in: PROCESSOR_POWER_POLICY // not implemented
//#define SystemPowerStateLogging         ((POWER_INFORMATION_LEVEL)23)     // in: SYSTEM_POWER_STATE_DISABLE_REASON[]
//#define SystemPowerLoggingEntry         ((POWER_INFORMATION_LEVEL)24)     // in: SYSTEM_POWER_LOGGING_ENTRY[] // (kernel-mode only)
//#define SetPowerSettingValue            ((POWER_INFORMATION_LEVEL)25)     // in: SYSTEM_POWER_SETTING_VALUE // (kernel-mode only)
...
//#define SystemMonitorHiberBootPowerOff  ((POWER_INFORMATION_LEVEL)28)     // in: NULL (PowerMonitorOff)
//#define SystemVideoState                ((POWER_INFORMATION_LEVEL)29)     // out: MONITOR_DISPLAY_STATE
//#define TraceApplicationPowerMessage    ((POWER_INFORMATION_LEVEL)30)     // in: (kernel-mode only)
//#define TraceApplicationPowerMessageEnd ((POWER_INFORMATION_LEVEL)31)     // in: (kernel-mode only)
//#define ProcessorPerfStates             ((POWER_INFORMATION_LEVEL)32)     // not implemented
//#define ProcessorIdleStates             ((POWER_INFORMATION_LEVEL)33)     // out: PROCESSOR_IDLE_STATES // (kernel-mode only)
//#define ProcessorCap                    ((POWER_INFORMATION_LEVEL)34)     // out: PROCESSOR_CAP // (kernel-mode only)
...
//#define TraceServicePowerMessage        ((POWER_INFORMATION_LEVEL)37)     // in: SYSTEM_SERVICE_POWER_MESSAGE // (kernel-mode only)
//#define ProcessorLoad                   ((POWER_INFORMATION_LEVEL)38)     // in: PROCESSOR_LOAD (sets), in: PPROCESSOR_NUMBER (clears)
//#define PowerShutdownNotification       ((POWER_INFORMATION_LEVEL)39)     // in: POWER_SHUTDOWN_NOTIFICATION
//#define MonitorCapabilities             ((POWER_INFORMATION_LEVEL)40)     // in: POWER_MONITOR_CAPABILITIES
//#define SessionPowerInit                ((POWER_INFORMATION_LEVEL)41)     // in: POWER_SESSION_POWER_INIT
//#define SessionDisplayState             ((POWER_INFORMATION_LEVEL)42)     // in: POWER_SESSION_DISPLAY_STATE
...
//#define NotifyUserModeLegacyPowerEvent  ((POWER_INFORMATION_LEVEL)47)     // in: (kernel-mode only)
//#define GroupPark                       ((POWER_INFORMATION_LEVEL)48)     // in: (debug-mode boot only)
//#define ProcessorIdleDomains            ((POWER_INFORMATION_LEVEL)49)     // in: (kernel-mode only)
//#define WakeTimerList                   ((POWER_INFORMATION_LEVEL)50)     // out: WAKE_TIMER_INFO[]
//#define SystemHiberFileSize             ((POWER_INFORMATION_LEVEL)51)     // out: ULONG
//#define ProcessorIdleStatesHv           ((POWER_INFORMATION_LEVEL)52)     // in: (kernel-mode only)
//#define ProcessorPerfStatesHv           ((POWER_INFORMATION_LEVEL)53)     // in: (kernel-mode only)
//#define ProcessorPerfCapHv              ((POWER_INFORMATION_LEVEL)54)     // int: PROCESSOR_PERF_CAP_HV // (kernel-mode only)
//#define ProcessorSetIdle                ((POWER_INFORMATION_LEVEL)55)     // in: (debug-mode boot only)
//#define LogicalProcessorIdling          ((POWER_INFORMATION_LEVEL)56)     // in: (kernel-mode only)
//#define UserPresence                    ((POWER_INFORMATION_LEVEL)57)     // out: POWER_USER_PRESENCE // not implemented
...
//#define GetPowerSettingValue            ((POWER_INFORMATION_LEVEL)59)     // in: GUID
//#define IdleResiliency                  ((POWER_INFORMATION_LEVEL)60)     // out: POWER_IDLE_RESILIENCY
//#define SessionRITState                 ((POWER_INFORMATION_LEVEL)61)     // out: POWER_SESSION_RIT_STATE
//#define SessionConnectNotification      ((POWER_INFORMATION_LEVEL)62)     // out: POWER_SESSION_WINLOGON
//#define SessionPowerCleanup             ((POWER_INFORMATION_LEVEL)63)     //
//#define SessionLockState                ((POWER_INFORMATION_LEVEL)64)     // out: POWER_SESSION_WINLOGON
//#define SystemHiberbootState            ((POWER_INFORMATION_LEVEL)65)     // out: BOOLEAN // fast startup supported
//#define PlatformInformation             ((POWER_INFORMATION_LEVEL)66)     // out: BOOLEAN // connected standby supported
//#define PdcInvocation                   ((POWER_INFORMATION_LEVEL)67)     // in: (kernel-mode only)
//#define MonitorInvocation               ((POWER_INFORMATION_LEVEL)68)     // in: (kernel-mode only)
//#define FirmwareTableInformationRegistered ((POWER_INFORMATION_LEVEL)69)  // in: (kernel-mode only)
//#define SetShutdownSelectedTime         ((POWER_INFORMATION_LEVEL)70)     // in: NULL
//#define SuspendResumeInvocation         ((POWER_INFORMATION_LEVEL)71)     // in: (kernel-mode only) // not implemented
...
//#define CsDeviceNotification            ((POWER_INFORMATION_LEVEL)74)     // in: (kernel-mode only)
//#define PlatformRole                    ((POWER_INFORMATION_LEVEL)75)     // out: POWER_PLATFORM_ROLE
//#define LastResumePerformance           ((POWER_INFORMATION_LEVEL)76)     // out: RESUME_PERFORMANCE
...
//#define RegisterSpmPowerSettings        ((POWER_INFORMATION_LEVEL)79)     // in: (kernel-mode only)
//#define PlatformIdleStates              ((POWER_INFORMATION_LEVEL)80)     // in: (kernel-mode only)
//#define ProcessorIdleVeto               ((POWER_INFORMATION_LEVEL)81)     // in: (kernel-mode only) // deprecated
//#define PlatformIdleVeto                ((POWER_INFORMATION_LEVEL)82)     // in: (kernel-mode only) // deprecated
//#define SystemBatteryStatePrecise       ((POWER_INFORMATION_LEVEL)83)     // out: SYSTEM_BATTERY_STATE
//#define ThermalEvent                    ((POWER_INFORMATION_LEVEL)84)     // in: THERMAL_EVENT // PowerReportThermalEvent
//#define PowerRequestActionInternal      ((POWER_INFORMATION_LEVEL)85)     // in: POWER_REQUEST_ACTION_INTERNAL
//#define BatteryDeviceState              ((POWER_INFORMATION_LEVEL)86)     //
//#define PowerInformationInternal        ((POWER_INFORMATION_LEVEL)87)     // in: POWER_INFORMATION_LEVEL_INTERNAL // PopPowerInformationInternal
//#define ThermalStandby                  ((POWER_INFORMATION_LEVEL)88)     // in: NULL // shutdown with thermal standby as reason.
//#define SystemHiberFileType             ((POWER_INFORMATION_LEVEL)89)     // in: ULONG // zero ? reduced : full // powercfg.exe /h /type
//#define PhysicalPowerButtonPress        ((POWER_INFORMATION_LEVEL)90)     // in: BOOLEAN
//#define QueryPotentialDripsConstraint   ((POWER_INFORMATION_LEVEL)91)     // in: (kernel-mode only)
//#define EnergyTrackerCreate             ((POWER_INFORMATION_LEVEL)92)     // in: POWER_INFORMATION_ENERGY_TRACKER_CREATE_INPUT, out: POWER_INFORMATION_ENERGY_TRACKER_CREATE_OUTPUT
//#define EnergyTrackerQuery              ((POWER_INFORMATION_LEVEL)93)     // in: POWER_INFORMATION_ENERGY_TRACKER_QUERY_INPUT, out: POWER_INFORMATION_ENERGY_TRACKER_QUERY_OUTPUT
//#define UpdateBlackBoxRecorder          ((POWER_INFORMATION_LEVEL)94)     // in: POWER_INFORMATION_BBR_UPDATE_REQUEST_INPUT
//#define SessionAllowExternalDmaDevices  ((POWER_INFORMATION_LEVEL)95)     // in: POWER_SESSION_ALLOW_EXTERNAL_DMA_DEVICES
//#define SendSuspendResumeNotification   ((POWER_INFORMATION_LEVEL)96)     // in: since WIN11
...
STATIC_ASSERT(sizeof(POWER_INTERNAL_ACPI_INTERFACE_REGISTER_INPUT) == 0x20);
...
//STATIC_ASSERT(sizeof(POWER_INTERNAL_SET_WATCHDOG) == 0x60);
...
STATIC_ASSERT(sizeof(POWER_INTERNAL_BOOTSTAT_CHECK_INTEGRITY_INPUT) == sizeof(POWER_INTERNAL_BOOTSTAT_GET_INPUT));
...
STATIC_ASSERT(sizeof(POWER_INTERNAL_TIME_BROKER_EXPIRATION_REASON_INPUT) == 0x90);
...
STATIC_ASSERT(sizeof(POWER_INTERNAL_PROCESSOR_BRANDED_FREQUENCY_INPUT) == 0x0C);
...
STATIC_ASSERT(sizeof(POWER_INTERNAL_PROCESSOR_BRANDED_FREQUENCY_OUTPUT) == 0x08);
...
STATIC_ASSERT(sizeof(POWER_INTERNAL_FAN_RPM_OUTPUT) == 0x58);
...
STATIC_ASSERT(sizeof(POWER_INTERNAL_NOTIFY_WIN32K_POWER_REQUEST_INPUT) == 0x0C);
...
STATIC_ASSERT(sizeof(POWER_INTERNAL_PDC_AGENT_SESSION_QUERY_INPUT) == 0x0C);
